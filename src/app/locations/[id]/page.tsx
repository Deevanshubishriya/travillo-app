...
async function getLocationDetails(id: string) {
  ...
  const locations = [
    { id: '1', name: 'Khirsu Village', description: 'A serene hill station offering panoramic views of the Himalayas. Perfect for a peaceful getaway, surrounded by oak and deodar forests. Enjoy nature walks and bird watching.', imageUrl: 'https://picsum.photos/seed/khirsu_detail/800/500', dataAiHint: 'khirsu himalayas', coordinates: { lat: 30.1978, lng: 78.8798 } },
