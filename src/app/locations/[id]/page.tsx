...
async function getLocationDetails(id: string) {
  ...
  const locations = [
    { id: '1', name: 'Khirsu Village', description: 'A serene hill station offering panoramic views of the Himalayas. Perfect for a peaceful getaway, surrounded by oak and deodar forests. Enjoy nature walks and bird watching.', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/7/7c/Khirsu_village_2.jpg', dataAiHint: 'khirsu village himalayas', coordinates: { lat: 30.1978, lng: 78.8798 } },
