...
const hiddenLocations = [
  { id: '1', name: 'Khirsu Village', description: 'A serene hill station offering panoramic views of the Himalayas.', imageUrl: 'https://picsum.photos/seed/khirsu/400/300', category: 'village', dataAiHint: 'khirsu village', coordinates: { lat: 30.1978, lng: 78.8798 } },
  { id: '2', name: 'Chopta Tungnath Trek', description: 'Known as "Mini Switzerland", offering breathtaking meadows and ancient temples.', imageUrl: 'https://picsum.photos/seed/chopta/400/300', category: 'trek', dataAiHint: 'chopta trek', coordinates: { lat: 30.4851, lng: 79.3331 } },
  { id: '3', name: 'Binsar Wildlife Sanctuary', description: 'Home to diverse flora and fauna, perfect for nature lovers.', imageUrl: 'https://picsum.photos/seed/binsar/400/300', category: 'nature', dataAiHint: 'binsar sanctuary', coordinates: { lat: 29.6949, lng: 79.7534 } },
  ...
  { id: '7', name: 'Lansdowne', description: 'A quiet cantonment town surrounded by thick oak and blue pine forests.', imageUrl: 'https://picsum.photos/seed/lansdowne/400/300', category: 'cantonment', dataAiHint: 'lansdowne colonial', coordinates: { lat: 29.8378, lng: 78.6865 } }, // Use Building2 icon
  ...
  { id: '10', name: 'Pauri', description: 'Offers breathtaking views of snow-capped peaks and lush green valleys.', imageUrl: 'https://picsum.photos/seed/pauri/400/300', category: 'viewpoint', dataAiHint: 'pauri garhwal', coordinates: { lat: 30.1498, lng: 78.7748 } }, // Use MountainSnow icon
