...
const hiddenLocations = [
  { id: '1', name: 'Khirsu Village', description: 'A serene hill station offering panoramic views of the Himalayas.', imageUrl: '/images/khirsuVillage.jpg', category: 'village', dataAiHint: 'khirsu village himalayas', coordinates: { lat: 30.1978, lng: 78.8798 } },
